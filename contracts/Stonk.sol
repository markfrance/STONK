 ...
 */
contract Stonk is Context, IERC20 {
    ...
    mapping (address => uint256) public lastTaxed;
    ...
    address public _spoStakingAddress;
    ...
    function getTaxAmount(address player) public view returns(uint256){
        ...
        uint256 taxPeriodsElapsed = getTimeSinceLastTaxed(player) / twelveHours;
